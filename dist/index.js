...
(function(exports) {
  ...
  var timeAsDigits = function (v) {
      ...
      if (v.minutes < 10) {
        var addedZero = "0"+v.minutes;
      }
      else {
        var addedZero = v.minutes;
      }  

        
      return Data_Show.show(Data_Show.showInt)(v.hours) + (":" + Data_Show.show(Data_Show.showInt)(addedZero));
  };
  ...
  var timeAsText = function (v) {
      ...
      if (v.minutes === 5) {
          return "fimm mínútur yfir " + hourName(v.hours);
      };
      if (v.minutes === 10) {
          return "tíu mínútur yfir " + hourName(v.hours);
      };
      if (v.minutes === 15) {
          return "korter yfir " + hourName(v.hours);
      };
      if (v.minutes === 20) {
          return "tuttugu mínútur yfir " + hourName(v.hours);
      };
      if (v.minutes === 25) {
          return "tuttugu og fimm mínútur yfir " + hourName(v.hours);
      };
      if (v.minutes === 30) {
          return "hálf-" + hourName(nextHour(v.hours));
      };
      if (v.minutes === 35) {
          return "tuttugu og fimm mínútur í " + hourName(nextHour(v.hours));
      };
      if (v.minutes === 40) {
          return "tuttugu mínútur í " + hourName(nextHour(v.hours));
      };
      if (v.minutes === 45) {
          return "korter í " + hourName(nextHour(v.hours));
      };      
      if (v.minutes === 50) {
          return "tíu mínútur í " + hourName(nextHour(v.hours));
      };      
      if (v.minutes === 55) {
          return "fimm mínútur í " + hourName(nextHour(v.hours));
      };
      return "";
  };
  ...
  var generateRandomTime = function (targetRef) {
      ...
      console.log(difficulty_frac[$('#difficulty').val()]);
      var randomTime = Control_Apply.apply(Control_Monad_Eff.applyEff)(Data_Functor.map(Control_Monad_Eff.functorEff)(Clock.time)(Control_Monad_Eff_Random.randomInt(1)(12)))(Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Semiring.mul(Data_Semiring.semiringInt)(difficulty[$('#difficulty').val()]))(Control_Monad_Eff_Random.randomInt(0)(difficulty_frac[$('#difficulty').val()])));
      return function __do() {
  ...
  var correct = function (targetRef) {
      return function __do() {  
          ...
          var v2 = Control_Monad_Eff_Timer.setTimeout(400)(Control_Monad_Eff_JQuery.display(v))();
          // var v3 = Control_Monad_Eff_Timer.setTimeout(4000)($('#exampleModal').modal('hide'))();
          setTimeout(function(){ $('#exampleModal').modal('hide'); }, 3000);
          var v4 = Control_Monad_Eff_Timer.setTimeout(3000)(Control_Monad_Eff_JQuery.hide(v))();
          // var v2 = Control_Monad_Eff_Timer.setTimeout(4000)()();
  ...
  var advanceTime = function (timeRef) {
      var add = function (v) {
          if (v.hours === 12 && v.minutes === 55) {
              return Clock.time(1)(0);
          };
          if (v.minutes === 55) {
              return Clock.time(v.hours + 1 | 0)(0);
          };
          return Clock.time(v.hours)(v.minutes + 5 | 0);
      };
      return function __do() {
