      ...
      return function (ctx) {
          return function __do() {
              var v = Graphics_Canvas.fillPath(ctx)(function __do() {
                  ...
                  var v1 = Graphics_Canvas.addColorStop(0.0)("#333")(v)();
                  var v2 = Graphics_Canvas.addColorStop(0.5)("white")(v1)();
                  var v3 = Graphics_Canvas.addColorStop(1.0)("#333")(v2)();
...
(function(exports) {
  ...
  var timeAsText = function (v) {
      if (v.minutes === 0) {
          return hourName(v.hours) + " \xf3ra";
      };
      if (v.minutes === 15) {
          return "negyed " + hourName(nextHour(v.hours));
      };
      if (v.minutes === 30) {
          return "f\xe9l " + hourName(nextHour(v.hours));
      };
      if (v.minutes === 45) {
          return "h\xe1romnegyed " + hourName(nextHour(v.hours));
      };
